  ...
  return (
    <AdminShell>
      ...
      <div className="filters">
        ...
        <label>Language<select className="select" defaultValue="en"><option value="en">English</option></select></label>
      ...
      <div className="grid grid-2" style={{ marginTop: 18 }}>
        <Link className="card" href="/admin/analytics"><h2>Analytics workspace</h2><p className="muted">Topic-level literacy, support need trends, language setting, and content effectiveness proxies.</p></Link>
        <Link className="card" href="/admin/content"><h2>Education content library</h2><p className="muted">Manage age-specific English health literacy materials and review status.</p></Link>
      </div>
    </AdminShell>
  );
}
